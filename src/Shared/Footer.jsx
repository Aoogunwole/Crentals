...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full py-2 px-4 md:px-10">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="FlowBite Logo" />
                  <h2 class="text-primary text-2xl font-bold font-font">cRENTALS</h2>
              </a>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 font-font">
              <div className="">
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-white">About</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          <a href="" class="hover:underline">Bussiness Relation</a>
                      </li>
                  </ul>
              </div>
              <div className="md:pl-10">
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-white">Community</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                      ...
                      <li class="mb-4">
                          <a href="" class="hover:underline">Invite a friend</a>
                      </li>
                  </ul>
              </div>
              <div className="md:pl-14">
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-white">Socials</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
